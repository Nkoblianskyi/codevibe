  ...
  return (
    <div className="container py-12 md:py-24">
      ...
      <div className="prose max-w-none">
        <p>Last updated: April 23, 2023</p>

        <h2>Introduction</h2>
        <p>
          This Cookie Policy explains how CodeVibeCo ("we", "us", or "our") uses cookies and similar technologies to
          recognize you when you visit our website at codevibeco.com ("Website"). It explains what these technologies
        ...
        <p>
          Cookies set by the website owner (in this case, CodeVibeCo) are called "first-party cookies". Cookies set by
        ...
        <p>
          ...
          info@codevibeco.com or contact us at:
        </p>
        <p>
          CodeVibeCo
          <br />
